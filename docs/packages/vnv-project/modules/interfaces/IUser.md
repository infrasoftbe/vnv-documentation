[@infrasoftbe/infrasoft-project](../README.md) / [Exports](../modules.md) / IUser
...
- [create\_dt](IUser.md#create_dt)
- [id](IUser.md#id)
- [name](IUser.md#name)
- [token](IUser.md#token)
- [type](IUser.md#type)
- [update\_dt](IUser.md#update_dt)
- [userGroup](IUser.md#usergroup)
