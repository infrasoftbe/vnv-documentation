[@infrasoftbe/infrasoft-project](../README.md) / [Exports](../modules.md) / IList
...
- [`INode`](INode.md)\<``"list"``, [`StructureMetadata`](../modules.md#structuremetadata)\>
...
- [create\_dt](IList.md#create_dt)
- [id](IList.md#id)
- [name](IList.md#name)
- [token](IList.md#token)
- [type](IList.md#type)
- [update\_dt](IList.md#update_dt)
- [userGroup](IList.md#usergroup)
