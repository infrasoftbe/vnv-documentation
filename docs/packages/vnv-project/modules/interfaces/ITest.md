[@infrasoftbe/infrasoft-project](../README.md) / [Exports](../modules.md) / ITest
...
- [`INode`](INode.md)\<`TestKinds`\>

  ↳ **`ITest`**

## Implemented by

- [`_test`](../classes/test.md)

## Table of contents

### Properties

- [create\_dt](ITest.md#create_dt)
- [id](ITest.md#id)
- [name](ITest.md#name)
- [token](ITest.md#token)
- [type](ITest.md#type)
- [update\_dt](ITest.md#update_dt)
- [userGroup](ITest.md#usergroup)
