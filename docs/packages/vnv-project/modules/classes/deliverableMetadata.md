[@infrasoftbe/infrasoft-project](../README.md) / [Exports](../modules.md) / \_deliverableMetadata

# Class: \_deliverableMetadata

The DeliverableMetadata class is a TypeScript class that implements the IDeliverableMetadata
interface and contains properties for description, external reference, estimated time, and estimated
cost.
...
- [constructor](deliverableMetadata.md#constructor)

### Properties

- [description](deliverableMetadata.md#description)
- [estimateCost](deliverableMetadata.md#estimatecost)
- [estimateTime](deliverableMetadata.md#estimatetime)
- [external](deliverableMetadata.md#external)
- [path](deliverableMetadata.md#path)
- [ref\_extern](deliverableMetadata.md#ref_extern)
- [status](deliverableMetadata.md#status)

### Accessors

- [jsonReady](deliverableMetadata.md#jsonready)
- [schema](deliverableMetadata.md#schema)

### Methods

- [assign](deliverableMetadata.md#assign)
- [complete](deliverableMetadata.md#complete)
- [ensureMetadata](deliverableMetadata.md#ensuremetadata)
- [flat](deliverableMetadata.md#flat)
- [isValidMetadata](deliverableMetadata.md#isvalidmetadata)
- [validate](deliverableMetadata.md#validate)
- [assign](deliverableMetadata.md#assign-1)
- [ensureMetadata](deliverableMetadata.md#ensuremetadata-1)
- [filterObjectBySchema](deliverableMetadata.md#filterobjectbyschema)

## Constructors

### constructor

• **new _deliverableMetadata**(`options?`): [`_deliverableMetadata`](deliverableMetadata.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `options?` | typeof [`_deliverableMetadata`](deliverableMetadata.md) |
...
[packages/infrasoft-vnv-project/src/models/metadats/deliverable.ts:21](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/metadats/deliverable.ts#L21)
...
[IDeliverableMetadata](../interfaces/IDeliverableMetadata.md).[description](../interfaces/IDeliverableMetadata.md#description)
...
[IDeliverableMetadata](../interfaces/IDeliverableMetadata.md).[estimateCost](../interfaces/IDeliverableMetadata.md#estimatecost)

#### Defined in

[packages/infrasoft-vnv-project/src/models/metadats/deliverable.ts:19](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/metadats/deliverable.ts#L19)
...
[IDeliverableMetadata](../interfaces/IDeliverableMetadata.md).[estimateTime](../interfaces/IDeliverableMetadata.md#estimatetime)

#### Defined in

[packages/infrasoft-vnv-project/src/models/metadats/deliverable.ts:18](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/metadats/deliverable.ts#L18)
...
[IDeliverableMetadata](../interfaces/IDeliverableMetadata.md).[external](../interfaces/IDeliverableMetadata.md#external)
...
[IDeliverableMetadata](../interfaces/IDeliverableMetadata.md).[path](../interfaces/IDeliverableMetadata.md#path)
...
[IDeliverableMetadata](../interfaces/IDeliverableMetadata.md).[ref_extern](../interfaces/IDeliverableMetadata.md#ref_extern)
...
▸ **assign**(`metadata`): [`_deliverableMetadata`](deliverableMetadata.md)
...
[packages/infrasoft-vnv-project/src/models/metadats/deliverable.ts:26](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/metadats/deliverable.ts#L26)
