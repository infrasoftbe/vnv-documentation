[@infrasoftbe/infrasoft-project](../README.md) / [Exports](../modules.md) / \_systemMetadata
...
- [constructor](systemMetadata.md#constructor)

### Properties

- [description](systemMetadata.md#description)
- [external](systemMetadata.md#external)
- [path](systemMetadata.md#path)
- [ref\_extern](systemMetadata.md#ref_extern)
- [status](systemMetadata.md#status)

### Accessors

- [jsonReady](systemMetadata.md#jsonready)
- [schema](systemMetadata.md#schema)

### Methods

- [assign](systemMetadata.md#assign)
- [complete](systemMetadata.md#complete)
- [ensureMetadata](systemMetadata.md#ensuremetadata)
- [flat](systemMetadata.md#flat)
- [isValidMetadata](systemMetadata.md#isvalidmetadata)
- [validate](systemMetadata.md#validate)
- [assign](systemMetadata.md#assign-1)
- [ensureMetadata](systemMetadata.md#ensuremetadata-1)
- [filterObjectBySchema](systemMetadata.md#filterobjectbyschema)

## Constructors

### constructor

• **new _systemMetadata**(`options?`): [`_systemMetadata`](systemMetadata.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `options?` | typeof [`_systemMetadata`](systemMetadata.md) |
...
[packages/infrasoft-vnv-project/src/models/metadats/system.ts:9](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/metadats/system.ts#L9)
...
[ISystemMetadata](../interfaces/ISystemMetadata.md).[description](../interfaces/ISystemMetadata.md#description)
...
[ISystemMetadata](../interfaces/ISystemMetadata.md).[external](../interfaces/ISystemMetadata.md#external)
...
[ISystemMetadata](../interfaces/ISystemMetadata.md).[path](../interfaces/ISystemMetadata.md#path)
...
[ISystemMetadata](../interfaces/ISystemMetadata.md).[ref_extern](../interfaces/ISystemMetadata.md#ref_extern)
...
▸ **assign**(`metadata`): [`_systemMetadata`](systemMetadata.md)
...
[packages/infrasoft-vnv-project/src/models/metadats/system.ts:14](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/metadats/system.ts#L14)
