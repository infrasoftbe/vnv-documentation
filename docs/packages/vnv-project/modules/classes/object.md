[@infrasoftbe/infrasoft-project](../README.md) / [Exports](../modules.md) / \_object

# Class: \_object

La classe `_object` est une classe TypeScript qui étend la classe `_node` et implémente l'interface
`IObjectNode`, représentant un nœud `objet` avec diverses propriétés telles que l'identifiant, le
nom, le jeton, la méta, create_dt et update_dt.
...
- [create\_dt](object.md#create_dt)
- [id](object.md#id)
- [name](object.md#name)
- [project](object.md#project)
- [token](object.md#token)
- [type](object.md#type)
- [update\_dt](object.md#update_dt)
- [userGroup](object.md#usergroup)

### Accessors

- [delete](object.md#delete)
- [forNodes](object.md#fornodes)
- [forRelationships](object.md#forrelationships)
- [fromNodes](object.md#fromnodes)
- [fromRelationships](object.md#fromrelationships)
- [getMetadata](object.md#getmetadata)
- [inNodes](object.md#innodes)
- [inRelationships](object.md#inrelationships)
- [jsonReady](object.md#jsonready)
- [outNodes](object.md#outnodes)
- [outRelationships](object.md#outrelationships)
- [setMetadata](object.md#setmetadata)
- [update](object.md#update)

### Methods

- [flat](object.md#flat)
- [json](object.md#json)
- [linkFor](object.md#linkfor)
- [linkFrom](object.md#linkfrom)
- [linkTo](object.md#linkto)
- [setMetaDataKey](object.md#setmetadatakey)
- [shema](object.md#shema)

## Constructors

### constructor

• **new _object**(`options`, `project?`): [`_object`](object.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `options` | [`INode`](../interfaces/INode.md)\<``"object"``, [`AllNodeMetadata`](../modules.md#allnodemetadata)\> |
...
[packages/infrasoft-vnv-project/src/models/nodes/object.ts:18](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/object.ts#L18)
...
[IObject](../interfaces/IObject.md).[create_dt](../interfaces/IObject.md#create_dt)
...
[packages/infrasoft-vnv-project/src/models/nodes/object.ts:15](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/object.ts#L15)
...
[IObject](../interfaces/IObject.md).[id](../interfaces/IObject.md#id)
...
[packages/infrasoft-vnv-project/src/models/nodes/object.ts:11](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/object.ts#L11)
...
[IObject](../interfaces/IObject.md).[name](../interfaces/IObject.md#name)
...
[packages/infrasoft-vnv-project/src/models/nodes/object.ts:12](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/object.ts#L12)
...
[IObject](../interfaces/IObject.md).[token](../interfaces/IObject.md#token)
...
[packages/infrasoft-vnv-project/src/models/nodes/object.ts:13](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/object.ts#L13)
...
[IObject](../interfaces/IObject.md).[type](../interfaces/IObject.md#type)
...
[packages/infrasoft-vnv-project/src/models/nodes/object.ts:10](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/object.ts#L10)
...
[IObject](../interfaces/IObject.md).[update_dt](../interfaces/IObject.md#update_dt)
...
[packages/infrasoft-vnv-project/src/models/nodes/object.ts:16](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/object.ts#L16)
...
[IObject](../interfaces/IObject.md).[userGroup](../interfaces/IObject.md#usergroup)
