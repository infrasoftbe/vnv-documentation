[@infrasoftbe/infrasoft-project](../README.md) / [Exports](../modules.md) / \_roleMetadata
...
- [constructor](roleMetadata.md#constructor)

### Properties

- [description](roleMetadata.md#description)
- [external](roleMetadata.md#external)
- [path](roleMetadata.md#path)
- [ref\_extern](roleMetadata.md#ref_extern)
- [status](roleMetadata.md#status)

### Accessors

- [jsonReady](roleMetadata.md#jsonready)
- [schema](roleMetadata.md#schema)

### Methods

- [assign](roleMetadata.md#assign)
- [complete](roleMetadata.md#complete)
- [ensureMetadata](roleMetadata.md#ensuremetadata)
- [flat](roleMetadata.md#flat)
- [isValidMetadata](roleMetadata.md#isvalidmetadata)
- [validate](roleMetadata.md#validate)
- [assign](roleMetadata.md#assign-1)
- [ensureMetadata](roleMetadata.md#ensuremetadata-1)
- [filterObjectBySchema](roleMetadata.md#filterobjectbyschema)

## Constructors

### constructor

• **new _roleMetadata**(`options?`): [`_roleMetadata`](roleMetadata.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `options?` | typeof [`_roleMetadata`](roleMetadata.md) |
...
[packages/infrasoft-vnv-project/src/models/metadats/role.ts:10](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/metadats/role.ts#L10)
...
[IRoleMetadata](../interfaces/IRoleMetadata.md).[description](../interfaces/IRoleMetadata.md#description)
...
[IRoleMetadata](../interfaces/IRoleMetadata.md).[external](../interfaces/IRoleMetadata.md#external)
...
[IRoleMetadata](../interfaces/IRoleMetadata.md).[path](../interfaces/IRoleMetadata.md#path)
...
[IRoleMetadata](../interfaces/IRoleMetadata.md).[ref_extern](../interfaces/IRoleMetadata.md#ref_extern)
...
▸ **assign**(`metadata`): [`_roleMetadata`](roleMetadata.md)
...
[packages/infrasoft-vnv-project/src/models/metadats/role.ts:15](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/metadats/role.ts#L15)
