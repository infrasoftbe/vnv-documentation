[@infrasoftbe/infrasoft-project](../README.md) / [Exports](../modules.md) / \_deliverable

# Class: \_deliverable

The Deliverable class is a subclass of Node and represents a deliverable with properties such as id,
name, token, meta, create_dt, and update_dt.
...
- [constructor](deliverable.md#constructor)

### Properties

- [create\_dt](deliverable.md#create_dt)
- [id](deliverable.md#id)
- [name](deliverable.md#name)
- [project](deliverable.md#project)
- [token](deliverable.md#token)
- [type](deliverable.md#type)
- [update\_dt](deliverable.md#update_dt)
- [userGroup](deliverable.md#usergroup)

### Accessors

- [delete](deliverable.md#delete)
- [forNodes](deliverable.md#fornodes)
- [forRelationships](deliverable.md#forrelationships)
- [fromNodes](deliverable.md#fromnodes)
- [fromRelationships](deliverable.md#fromrelationships)
- [getMetadata](deliverable.md#getmetadata)
- [inNodes](deliverable.md#innodes)
- [inRelationships](deliverable.md#inrelationships)
- [jsonReady](deliverable.md#jsonready)
- [outNodes](deliverable.md#outnodes)
- [outRelationships](deliverable.md#outrelationships)
- [setMetadata](deliverable.md#setmetadata)
- [update](deliverable.md#update)

### Methods

- [flat](deliverable.md#flat)
- [json](deliverable.md#json)
- [linkFor](deliverable.md#linkfor)
- [linkFrom](deliverable.md#linkfrom)
- [linkTo](deliverable.md#linkto)
- [setMetaDataKey](deliverable.md#setmetadatakey)
- [shema](deliverable.md#shema)

## Constructors

### constructor

• **new _deliverable**(`options`, `project?`): [`_deliverable`](deliverable.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `options` | [`INode`](../interfaces/INode.md)\<``"deliverable"``, [`AllNodeMetadata`](../modules.md#allnodemetadata)\> |
| `project?` | [`ProxyProjectInstance`](../modules.md#proxyprojectinstance) |

#### Returns

[`_deliverable`](deliverable.md)
...
[packages/infrasoft-vnv-project/src/models/nodes/deliverable.ts:17](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/deliverable.ts#L17)
...
[IDeliverable](../interfaces/IDeliverable.md).[create_dt](../interfaces/IDeliverable.md#create_dt)
...
[packages/infrasoft-vnv-project/src/models/nodes/deliverable.ts:14](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/deliverable.ts#L14)
...
[IDeliverable](../interfaces/IDeliverable.md).[id](../interfaces/IDeliverable.md#id)
...
[packages/infrasoft-vnv-project/src/models/nodes/deliverable.ts:10](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/deliverable.ts#L10)
...
[IDeliverable](../interfaces/IDeliverable.md).[name](../interfaces/IDeliverable.md#name)
...
[packages/infrasoft-vnv-project/src/models/nodes/deliverable.ts:11](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/deliverable.ts#L11)
...
[IDeliverable](../interfaces/IDeliverable.md).[token](../interfaces/IDeliverable.md#token)
...
[packages/infrasoft-vnv-project/src/models/nodes/deliverable.ts:12](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/deliverable.ts#L12)
...
[IDeliverable](../interfaces/IDeliverable.md).[type](../interfaces/IDeliverable.md#type)
...
[packages/infrasoft-vnv-project/src/models/nodes/deliverable.ts:9](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/deliverable.ts#L9)
...
[IDeliverable](../interfaces/IDeliverable.md).[update_dt](../interfaces/IDeliverable.md#update_dt)
...
[packages/infrasoft-vnv-project/src/models/nodes/deliverable.ts:15](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/deliverable.ts#L15)
...
[IDeliverable](../interfaces/IDeliverable.md).[userGroup](../interfaces/IDeliverable.md#usergroup)
