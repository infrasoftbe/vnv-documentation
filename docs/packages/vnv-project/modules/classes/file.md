[@infrasoftbe/infrasoft-project](../README.md) / [Exports](../modules.md) / \_file

# Class: \_file

The `File` class represents a file node with properties such as id, name, token, metadata, create
...
- [create\_dt](file.md#create_dt)
- [id](file.md#id)
- [name](file.md#name)
- [project](file.md#project)
- [token](file.md#token)
- [type](file.md#type)
- [update\_dt](file.md#update_dt)
- [userGroup](file.md#usergroup)

### Accessors

- [delete](file.md#delete)
- [forNodes](file.md#fornodes)
- [forRelationships](file.md#forrelationships)
- [fromNodes](file.md#fromnodes)
- [fromRelationships](file.md#fromrelationships)
- [getMetadata](file.md#getmetadata)
- [inNodes](file.md#innodes)
- [inRelationships](file.md#inrelationships)
- [jsonReady](file.md#jsonready)
- [outNodes](file.md#outnodes)
- [outRelationships](file.md#outrelationships)
- [setMetadata](file.md#setmetadata)
...
- [flat](file.md#flat)
- [json](file.md#json)
- [linkFor](file.md#linkfor)
- [linkFrom](file.md#linkfrom)
- [linkTo](file.md#linkto)
- [setMetaDataKey](file.md#setmetadatakey)
- [shema](file.md#shema)
...
• **new _file**(`options`, `project?`): [`_file`](file.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `options` | [`INode`](../interfaces/INode.md)\<``"file"``, [`AllNodeMetadata`](../modules.md#allnodemetadata)\> |
...
[packages/infrasoft-vnv-project/src/models/nodes/file.ts:17](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/file.ts#L17)
...
[IFile](../interfaces/IFile.md).[create_dt](../interfaces/IFile.md#create_dt)
...
[packages/infrasoft-vnv-project/src/models/nodes/file.ts:14](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/file.ts#L14)
...
[IFile](../interfaces/IFile.md).[id](../interfaces/IFile.md#id)
...
[packages/infrasoft-vnv-project/src/models/nodes/file.ts:10](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/file.ts#L10)
...
[IFile](../interfaces/IFile.md).[name](../interfaces/IFile.md#name)
...
[packages/infrasoft-vnv-project/src/models/nodes/file.ts:11](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/file.ts#L11)
...
[IFile](../interfaces/IFile.md).[token](../interfaces/IFile.md#token)
...
[packages/infrasoft-vnv-project/src/models/nodes/file.ts:12](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/file.ts#L12)
...
[IFile](../interfaces/IFile.md).[type](../interfaces/IFile.md#type)
...
[packages/infrasoft-vnv-project/src/models/nodes/file.ts:9](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/file.ts#L9)
...
[IFile](../interfaces/IFile.md).[update_dt](../interfaces/IFile.md#update_dt)
...
[packages/infrasoft-vnv-project/src/models/nodes/file.ts:15](https://github.com/infrasoftbe/Infrasoft-vnv-ritual-project/blob/8c55713745804fbf004d7add2c4b90690c1560d1/src/models/nodes/file.ts#L15)
...
[IFile](../interfaces/IFile.md).[userGroup](../interfaces/IFile.md#usergroup)
