...
import { Accordion , AccordionItem , AccordionToggle , AccordionContent } from '@infrasoftbe/infrasoft-ui-components';
  ...
  const Element = () => {
    return <React.Fragment>
      <Accordion>
        <AccordionItem>
          <AccordionToggle
            isExpanded={expandedItem === 'accordion-item-1'}
          >
            Toggle text...
          </AccordionToggle>
          <AccordionContent isHidden={expandedItem !== 'accordion-item-1'}>
            Content text...
          </AccordionContent>
        </AccordionItem>
      </Accordion>
